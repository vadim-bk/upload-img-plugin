...
var upload = function upload(selector) {
  ...
  var handleCLickRemove = function handleCLickRemove(e) {
  ...
  preview.addEventListener('click', handleCLickRemove);
  uploadBtn.addEventListener('click', handleClickUpload);
};
  ...
  onUpload: function onUpload(files, blocks) {
    files.forEach(function (file, i) {
      ...
      task.on('state_changed', function (snapshot) {
        ...
        var block = blocks[i].querySelector('.preview-info-progress');
